...
public class TextFieldFrame extends JFrame 
{
   ...
   private class TextFieldHandler implements ActionListener 
   {
      ...
      public void actionPerformed( ActionEvent event )
      {
         ...
         if ( event.getSource() == textField1 ){//getSource() will return the object on which the event occurred. 
        	 								   //We check it with the == because we want to know if it is the same reference. 
            string = String.format( "textField1: %s",
               event.getActionCommand() );//this will obtain the text passed into the text field. 
            }
